...
function add_switched_LC_banks(crt, name, C, L, N_paths, t_delay)
...
for i = 1:N_paths
    ...
    L1_name = ['SWA',num2str(i),'_',name];
    L2_name = ['SWB',num2str(i),'_',name];
    ...
    add_inductor(crt, L1_name, L/2);
    add_inductor(crt, L2_name, L/2);
    
    paths_names{i} = ['PATH',num2str(i),'_',name];
    connect_in_series(crt, paths_names{i}, {switch1_name, L1_name, ['SHUNT_',cap_name], L2_name, switch2_name});
end
